...
поручения и саммари. Экспорт пока не реализован.
...
`/health/ready` (503 до реализации полного протокола с экспортом).
...
Следующие отдельные сущности планируются для редактора поручений:
